...
class LoanApplication(models.Model):
    ...
    no_emp = models.IntegerField(null=False, blank=False)
    create_job = models.IntegerField(null=False, blank=False)
    retained_job = models.IntegerField(null=False, blank=False)
